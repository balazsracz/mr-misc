...
//I/O pin definitions are correct for your hardware platform).
    ...
    //LED definition, applicable if using ENABLE_USB_LED_BLINK_STATUS option in usb_config.h
    #define mLED1       LATCbits.LATC3
    #define mLED1Tris   TRISCbits.TRISC3
    /** SWITCH *********************************************************/
    #define mInitSwitch2()      {ANS10 = 0; nRABPU = 0; TRISBbits.TRISB4 = 1; WPUB4 = 1; NOP();}                      //No TRISA3 bit.  RA3 is input only on this device
    #define sw2                 (PORTBbits.RB4)
