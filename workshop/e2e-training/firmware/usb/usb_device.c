...
#ifdef _18F14K50
#define BDTADDR 0x200
#elif defined(_18F26J50)
#define BDTADDR 0x400
#else
#error Define BDTADDR for your cpu.
#endif
	volatile BDT_ENTRY BDT[(USB_MAX_EP_NUMBER + 1) * 4] @ BDTADDR;
#endif
 ...
 *******************************************************************/
	...
	volatile CTRL_TRF_SETUP SetupPkt @ 0x240;           // 8-byte only
	volatile BYTE CtrlTrfData[USB_EP0_BUFF_SIZE] @ 0x248;
#else
...
// Can provide compile time option to do software pingpong
	    ...
	    volatile unsigned char hid_report_in[HID_INT_IN_EP_SIZE] @ 0x540;
	#else
