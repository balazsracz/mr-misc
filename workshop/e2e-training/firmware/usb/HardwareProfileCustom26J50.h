...
#ifndef HARDWARE_PROFILE_CUSTOM_26J50_H
#define HARDWARE_PROFILE_CUSTOM_26J50_H
...
DEF_LED(USB4, bLED0);
    ...
    #define mLED_1              LED_USB1
    #define mLED_2              LED_USB2
    #define mLED_3              LED_USB3
    #define mLED_4              LED_USB4
...
#endif  //HARDWARE_PROFILE_CUSTOM_26J50_H
