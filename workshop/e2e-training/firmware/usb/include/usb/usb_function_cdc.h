...
#define CDC_TX_COMPLETING           3
	...
	// The original identifiers exceed 31 characters and don't work with picc18
	#if defined(UCSACMC_D3)
	    #error This option is not currently supported.
	#else
	    #define UCSACMC_D3_VAL 0x00
	#endif
	
	#if defined(UCSACMC_D2)
	    #define UCSACMC_D2_VAL 0x04
	#else
	    #define UCSACMC_D2_VAL 0x00
	#endif
	
	#if defined(UCSACMC_D1)
	    #define UCSACMC_D1_VAL 0x02
	#else
	    #define UCSACMC_D1_VAL 0x00
	#endif
	
	#if defined(UCSACMC_D0)
	    #error This option is not currently supported.
	#else
	    #define UCSACMC_D0_VAL 0x00
	#endif
