...
//#define DEMO_BOARD USER_DEFINED_BOARD
            ...
            #ifdef DCC_CONTROLLER
              #include "HardwareProfileDccBoard.h"
            #else
              #include "HardwareProfileLowPinCount.h"
            #endif
        #elif defined(__18F46J50)
            #include "HardwareProfile - PIC18F46J50 PIM.h"
        #elif defined(__18F26J50)
            #include "HardwareProfileCustom26J50.h"
        #endif
#endif
...
//#define DEF_LED(name, map) extern near bit LED_##name @ map;
