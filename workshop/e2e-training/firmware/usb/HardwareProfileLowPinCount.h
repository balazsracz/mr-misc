...
#ifndef HW_PROF_LOW_PIN_C
#define HW_PROF_LOW_PIN_C
...
/*#define bLED0 ((unsigned)&LATB*8)+0   //nonexistant bit
#define bLED1 ((unsigned)&LATC*8)+0
#define bLED2 ((unsigned)&LATC*8)+2
#define bLED3 ((unsigned)&LATC*8)+1
#define bLED4 ((unsigned)&LATC*8)+3
*/
